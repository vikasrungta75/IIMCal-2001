  ...
  return (
    <>
      ...
      <main className="pt-20 pb-12 px-4 max-w-7xl mx-auto">
        ...
        {/* Welcome Banner */}
        <div className="rounded-2xl p-8 mb-8 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #003366 0%, #001a33 100%)' }}>
          <div className="absolute right-0 top-0 w-64 h-full opacity-10" style={{
            backgroundImage: 'radial-gradient(circle at center, #C8A951, transparent)',
          }} />
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="text-right hidden md:block">
              <div className="text-5xl font-display font-black" style={{ color: '#C8A951' }}>25</div>
        ...
        {/* Event Countdown */}
        <div className="iimc-card p-5 mb-8 flex flex-wrap items-center gap-4 justify-between">
          ...
          <div className="flex gap-3">
            <div className="text-center px-4 py-2 rounded-lg" style={{ background: '#f0ebe0' }}>
              <div className="font-display text-xl font-bold" style={{ color: '#003366' }}>3</div>
              <div className="text-xs text-gray-500">Days</div>
            </div>
            <div className="text-center px-4 py-2 rounded-lg" style={{ background: '#f0ebe0' }}>
              <div className="font-display text-xl font-bold" style={{ color: '#003366' }}>Nov</div>
              <div className="text-xs text-gray-500">Month</div>
            </div>
            <div className="text-center px-4 py-2 rounded-lg" style={{ background: '#f0ebe0' }}>
              <div className="font-display text-xl font-bold" style={{ color: '#003366' }}>2025</div>
        ...
        {!profileComplete && (
          <div className="rounded-xl p-4 mb-8 flex items-center gap-3 justify-between" style={{ background: 'rgba(200,169,81,0.1)', border: '1px solid rgba(200,169,81,0.3)' }}>
            <div className="flex items-center gap-3">
            ...
            <Link href="/profile" className="gold-btn px-4 py-2 rounded-lg text-sm whitespace-nowrap">
              Complete Profile
            </Link>
          </div>
        )}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <Link key={href} href={href} className="iimc-card p-5 block">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
              ...
              {announcements.map((a) => (
                <div key={a.id} className="iimc-card p-5">
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-400">
                    ...
                    <span className={`badge-${a.category === 'important' ? 'red' : a.category === 'event' ? 'navy' : 'gold'}`}>{a.category}</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="space-y-5">
            ...
            <div className="iimc-card p-5">
              ...
              <Link href="/profile" className="mt-4 block text-center navy-btn py-2 rounded-lg text-sm">
                Edit Profile
              </Link>
            </div>

            {/* Achievement */}
            <div className="rounded-xl p-5 text-center" style={{ background: 'linear-gradient(135deg, #003366, #001a33)' }}>
              ...
              <p className="text-blue-200 text-xs mt-3 font-crimson italic">
                "The bonds forged at Joka last a lifetime"
              </p>
            </div>
          </div>
        </div>
